...
allow access control providers to masquerade as their users\todo{Consumers and
...
\begin{compactdesc}
    ...
    \item[Access Control Provider (AP)] A helper service for facilitating
      access control. Every DRACL user\todo{again, that word} will have an AP (just like every email
...
\todo[inline]{David: I can't discuss Facebook etc. without first specifying a criteria
...
because it simply wouldn't fit with the web as it is today.\todo[inline]{How much do you
  want me to explain this? My argument is basically: Not even TOR is secure against
  global adversaries, hiding content from content hosts would require extensive
  modification of the content hosts. I could just lump this with the
  practicality goal.}
...
for DRACL.\todo{This is still somewhat detailed. However, I would like some
